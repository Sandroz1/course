...
export const courseSections: CourseSection[] = [
  {
    ...
    number: "0",
    title: "Подготовка",
    description: "Базовый C++ перед ООП: программа, компилятор, main, include, ввод, вывод, типы, функции, условия, циклы и массивы.",
  ...
  },
  {
    ...
    number: "1",
    title: "Что такое ООП",
    description: "Объекты, классы, поля, методы, состояние, поведение и поиск сущностей в условии задачи.",
  ...
  },
  {
    ...
    number: "2",
    title: "Структуры",
    description: "`struct`, поля, объект структуры, точка, функции и передача через `const Person&`.",
  ...
  },
  {
    ...
    number: "3",
    title: "Классы",
    description: "Класс, отличие от struct, private, public, поля, методы, объект и вызов через точку.",
  ...
  },
  {
    ...
    description: "Конструктор, параметры, перегрузка, деструктор и жизненный цикл объекта.",
  ...
  },
  {
    ...
    number: "5",
    title: "this",
    description: "`this`, указатель на текущий объект, `this->name = name` и проблема `name = name`.",
  ...
  },
  {
    ...
    description: "`main.cpp`, `.hpp`, `.cpp`, объявление, реализация и `ClassName::methodName`.",
  ...
  },
  {
    ...
    number: "7",
    title: "Препроцессор",
    description: "`#include`, `<iostream>` против `\"Bed.hpp\"`, `#pragma once`, `#ifndef`, `#define`, `#endif`.",
  ...
  },
  {
    ...
    description: "Двоеточие после конструктора, инициализация полей и отличие от присваивания.",
  ...
  },
  {
    ...
    number: "9",
    title: "std::vector",
    description: "Динамический список: `push_back`, `erase`, `size`, `empty`, индексы и меню.",
  ...
  },
  {
    ...
    number: "11",
    title: "Инкапсуляция",
    description: "`private`, геттеры, сеттеры, проверка данных, `explicit` и контролируемый доступ.",
  ...
  },
  {
    ...
    number: "12",
    title: "Исключения",
    description: "`throw`, `try`, `catch`, `runtime_error`, `exception`, `what()` и ограничения доступа.",
