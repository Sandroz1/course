...
- Учебный контент: `site/src/content/course`, `site/src/data`, internal starter sources в `practice`.
...
- `practice/` - internal `.cpp/.hpp` заготовки задач, не обязательная папка для обычного пользователя сайта.
