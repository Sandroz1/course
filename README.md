...
Доступ к AI разрешён только авторизованным пользователям с подтверждённым телефоном. Лимит backend: 15 запросов в день на пользователя.
...
- AI ограничен подтверждённым телефоном и дневным лимитом;
