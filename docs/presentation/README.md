...
- Каталог задач, фильтры, task detail flow и practice-файлы.
...
5. Открыть task detail: файл, результат, подсказки, self-check и связь с practice.
